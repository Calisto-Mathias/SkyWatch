...
function App() {
  ...
  const onSubmit = async (e) => {
    ...
    if (response) {
      setResponse(response.data.caption);
    }
  };
  ...
  return (
    <>
      <div className="h-screen w-screen background-image relative overflow-x-hidden">
        <nav className="w-screen h-[15vh] fixed flex lg:justify-between justify-center items-center px-[100px] bg-[rgb(0,0,0,0.5)]">
          <ul className="hidden lg:list-none lg:flex lg:justify-content lg:items-center lg:gap-10">
            ...
            <li>
              <div className="text-white">#Sensing</div>
            </li>
          </ul>
        ...
        <div
          className="h-screen w-screen bg-black flex flex-col gap-5 justify-center items-center"
          id="upload"
        >
          <div className="border-2 border-zinc-300  w-[80%] lg:w-[50%] rounded flex flex-col justify-center items-center py-10 gap-[30px] lg:gap-5">
            ...
            >
              ...
              <button
                type="submit"
                className="text-white rounded border-2 border-zinc-300 px-5 py-3"
              >
                Upload!
              </button>
            </form>
          ...
          {response && (
            <div className="border-2 border-zinc-300 w-[80%] lg:w-[50%] rounded flex flex-row justify-center items-center py-5 text-white text-center">
              {response}
            </div>
          )}
        </div>
